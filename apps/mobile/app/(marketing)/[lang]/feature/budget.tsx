      ...
      <View className="w-full py-20 px-6 bg-accent-cream items-center">
        <View style={{ maxWidth: 700, width: "100%", alignItems: "center" }}>
          <Display
            ...
            size={40}
            weight="700"
            style={{ textAlign: "center", marginBottom: 16, lineHeight: 48 }}
          >
          ...
          <View className="flex-row gap-3 flex-wrap justify-center">
            <MarketingLink
              href={localizedPath(lang, "/tools/budget-calculator") as any}
              title={t("budget.hero.ctaPrimary")}
            ...
            <MarketingLink
              href="/home"
              title={t("budget.hero.ctaSecondary")}
